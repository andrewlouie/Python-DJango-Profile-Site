...
try {
	...
	$sql="SELECT t.title,t.shortdesc,t.price,t.pics,t.longdesc,t.quantity,t.visible,t.cat_id,t.saleprice,category FROM toys t LEFT JOIN category ON t.cat_id = category.cat_id WHERE item = " . $_GET['id'];

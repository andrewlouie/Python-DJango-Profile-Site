...
<a href="http://www.twitter.com/ToyCharm"><img src="include/twitter.png" width="102" height="35" alt=""/></a><br>
</div></div>
		...
		<span class="pull-right">&copy; <?php echo date("Y") ?> Toy Charm. Website by Andrew Aaron
</span>
</div>
...
var changing = false;
function addcat() {
var newcat = prompt("category name");
if (newcat != "")
...
<label>category: </label><select id="catid" name="catid" onchange="changed()"><option></option></select><br><label></label><input type="button" value="Add a category" onclick="addcat()"> <input type="button" value="Remove category" onclick="delcat()"><br><br>
